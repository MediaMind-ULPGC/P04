...
""" Nota Do """
class PianoDo(PianoMusicalNotes):
...
""" Nota Do# / Reb"""
class PianoDoSostenidoReb(PianoMusicalNotes):
...
""" Nota Re """
class PianoRe(PianoMusicalNotes):
...
""" Nota Re# / Mib """
class PianoReSostenidoMib(PianoMusicalNotes):
...
""" Nota Mi """
class PianoMi(PianoMusicalNotes):
...
""" Nota Fa """
class PianoFa(PianoMusicalNotes):
...
""" Nota Fa# / Solb """
class PianoFaSostenidoSolb(PianoMusicalNotes):
...
""" Nota Sol """
class PianoSol(PianoMusicalNotes):
...
""" Nota Sol# / Lab """
class PianoSolSostenidoLab(PianoMusicalNotes):
...
""" Nota La """
class PianoLa(PianoMusicalNotes):
...
""" Nota La# / Sib """
class PianoLaSostenidoSib(PianoMusicalNotes):
...
""" Nota Si """
class PianoSi(PianoMusicalNotes):
